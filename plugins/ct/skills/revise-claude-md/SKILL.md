...
description: Update CLAUDE.md with learnings from this session. Manual trigger only.
...
> Adapted from the [claude-md-management](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/claude-md-management) plugin by Anthropic (Isabella He). The plugin was removed from this project as its always-loaded audit skill was not worth the context cost, but this command remains useful on-demand.
