...
## When to Use
- Teaching complex topics requiring foundational knowledge
- Creating documentation that teaches while documenting
- Onboarding to complex systems
- Explaining architectural decisions incrementally
- Refactoring educational materials
